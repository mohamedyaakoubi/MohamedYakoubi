...
export const alt = 'Projects - Mohamed Yaakoubi'
    ...
    (
      <div
        style={{
          ...
          padding: '60px',
          background: 'linear-gradient(135deg, #3b0764 0%, #581c87 40%, #6b21a8 100%)',
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={{ width: '80px', height: '4px', background: '#c084fc', borderRadius: '2px' }} />
          ...
          <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '26px', margin: 0 }}>
            AI-Powered Tools - Healthcare - Career Platforms - Open Source
          </p>
        </div>
