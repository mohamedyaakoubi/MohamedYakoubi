...
export default async function Image() {
  // Case matters: git tracks this file as "Documed.PNG" (lowercase m). Windows shows it as
  // "DocuMed.PNG", but Vercel builds on case-sensitive Linux, where that name does not exist.
  const imgBuffer = await readFile(join(process.cwd(), 'public', 'Documed.PNG'))
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '48px' }}>
          <img
            ...
            width={340}
            height={220}
            alt="DocuMed healthcare management platform screenshot"
