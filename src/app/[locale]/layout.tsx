...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...
      'Mohamed Yaakoubi', 'freelance developer', 'AI data annotation', 'localization'
    ].join(', '),
    authors: [{ name: 'Mohamed Yaakoubi', url: 'https://mohamed-yakoubi.vercel.app' }],
    creator: 'Mohamed Yaakoubi',
    publisher: 'Mohamed Yaakoubi',
    alternates: {
      canonical: `https://mohamed-yakoubi.vercel.app/${locale}`,
      languages: {
        'en': 'https://mohamed-yakoubi.vercel.app/en',
        'fr': 'https://mohamed-yakoubi.vercel.app/fr',
        'ar': 'https://mohamed-yakoubi.vercel.app/ar',
        'x-default': 'https://mohamed-yakoubi.vercel.app/en', // Default for unknown locales
      }
    },
    openGraph: {
      title: titles[locale as keyof typeof titles] || titles.en,
...
export default async function LocaleLayout({
  ...
  return (
    <>
      ...
      <link rel="alternate" hrefLang="en" href="https://mohamed-yakoubi.vercel.app/en" />
      <link rel="alternate" hrefLang="fr" href="https://mohamed-yakoubi.vercel.app/fr" />
      <link rel="alternate" hrefLang="ar" href="https://mohamed-yakoubi.vercel.app/ar" />
      <link rel="alternate" hrefLang="x-default" href="https://mohamed-yakoubi.vercel.app/en" />
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "alternateName": ["Yaakoubi Mohamed", "محمد يعقوبي"],
      ...
      <div className={`${inter.variable} ${ibmPlexSansArabic.variable} ${direction}`} dir={direction}>
        <ThemeProvider
          attribute="class"
          defaultTheme="light"
          enableSystem
