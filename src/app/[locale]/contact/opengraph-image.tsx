...
export const alt = 'Contact Mohamed Yaakoubi'
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={{ width: '80px', height: '4px', background: '#2dd4bf', borderRadius: '2px' }} />
          <h1 style={{ color: 'white', fontSize: '72px', fontWeight: 800, lineHeight: 1.1, margin: 0 }}>
            Get In Touch
          </h1>
          <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '26px', margin: 0 }}>
            AI Solutions - Translation - Localization - Web Development
          </p>
        </div>
