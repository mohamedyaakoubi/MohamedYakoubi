export const postContent = {
  title: "الذكاء الاصطناعي بناه. أنا كسرته. والذكاء الاصطناعي ساعدني في كسره.",
  heroTitle: `<span class="hero-safe">الذكاء الاصطناعي بناه.</span> <span class="hero-warn">أنا كسرته.</span><br><em class="hero-danger">والذكاء الاصطناعي ساعدني في كسره.</em>`,
  description: "قصة فضول، حملة لعبة، ثقة عمياء بالعميل، وما يحدث حين يُطلق تطوير مدعوم بالذكاء الاصطناعي دون منظور أمني — تحليل أُجري هو الآخر بمساعدة الذكاء الاصطناعي.",
  heroTag: "تحليل أمني · 24/03/2026",
...
:::diagram
العميل|إنشاء جلسة|الخادم
الخادم|{ sessionId }|العميل|لا سرّ. لا مفتاح توقيع.
العميل|"توليد النتيجة"|الخادم|مجرد إشارة تشغيل.
الخادم|{ input1, input2, score }|العميل|الخادم يولّد. الخادم يحسب النقاط.
العميل|"تسليم الجولة"|الخادم|لا قيم. الخادم يعرف بالفعل.
الخادم|{ roundResult }|العميل
:::
...
:::quote
أدوات البرمجة بالذكاء الاصطناعي تُحسّن لشيء واحد: <span>جعل الكود يعمل.</span>
هي ليست مهندسي أمن.
:::
...
2. **لا تُعد أبداً الأسرار في ردود الـ API.** إذا كنت تُوقّع البيانات، فلا يجب أن يسافر مفتاح التوقيع إلى العميل. إذا كان لدى العميل المفتاح، فالتوقيع لا يُثبت شيئاً.
