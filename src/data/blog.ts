...
export const aiCyberTheme: BlogTheme = {
  ...
  cardAccentText: 'text-red-700 dark:text-red-400',
  cardAccentHover: 'hover:text-red-800 dark:hover:text-red-300',
  cardCategoryBg: 'bg-red-500/10',
  cardCategoryText: 'text-red-700 dark:text-red-400',
...
export const ragChallengeTheme: BlogTheme = {
  ...
  cardAccentText: 'text-blue-700 dark:text-blue-400',
  cardAccentHover: 'hover:text-blue-800 dark:hover:text-blue-300',
  cardCategoryBg: 'bg-blue-500/10',
  cardCategoryText: 'text-blue-700 dark:text-blue-400',
