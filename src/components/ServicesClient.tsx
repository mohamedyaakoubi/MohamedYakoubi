      ...
      <div className="container mx-auto px-6">
        <motion.div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            {translations.services?.pageTitle || translations.services?.title || 'Professional Services'}
          </h1>
        ...
        <h2 className="sr-only">
          {selectedCategory === "all"
            ? (translations.services?.sectionTitle || "Available Services")
            : (translations.services?.categories?.[selectedCategory] || selectedCategory)}
        </h2>
